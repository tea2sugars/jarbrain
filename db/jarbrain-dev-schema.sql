...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores bean items.' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores information about all defined bean types.' AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `cache_path_breadcrumbs`
--

CREATE TABLE `cache_path_breadcrumbs` (
  `cid` varchar(255) NOT NULL DEFAULT '' COMMENT 'Primary Key: Unique cache ID.',
  `data` longblob COMMENT 'A collection of data to cache.',
  `expire` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry should expire, or 0 for never.',
  `created` int(11) NOT NULL DEFAULT '0' COMMENT 'A Unix timestamp indicating when the cache entry was created.',
  ...
  PRIMARY KEY (`cid`),
  KEY `expire` (`expire`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Cache table used to store information about path...';
...
--
-- Table structure for table `epsacrop_files`
--

CREATE TABLE `epsacrop_files` (
  `fid` int(10) unsigned NOT NULL COMMENT 'TODO: please describe this field!',
  `coords` longtext NOT NULL COMMENT 'TODO: please describe this field!',
  PRIMARY KEY (`fid`)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Entity table for panel pane content with fields.' AUTO_INCREMENT=1 ;
...
CREATE TABLE `fieldable_panels_panes_revision` (
  ...
  PRIMARY KEY (`vid`),
  KEY `fpid` (`fpid`,`vid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Entity revision table for panel pane content with fields.' AUTO_INCREMENT=1 ;
...
CREATE TABLE `field_data_field_caption` (
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_caption_value` varchar(200) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 7 (field_caption)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_client`
--

CREATE TABLE `field_data_field_client` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_client_tid` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_client_tid` (`field_client_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 10 (field_client)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_cover_image`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 6 (field_cover_image)';

-- --------------------------------------------------------

--
-- Table structure for table `field_data_field_external_url`
--

CREATE TABLE `field_data_field_external_url` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_external_url_url` varchar(2048) DEFAULT NULL,
  `field_external_url_title` varchar(255) DEFAULT NULL,
  `field_external_url_attributes` mediumtext,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 8 (field_external_url)';
...
--
-- Table structure for table `field_data_field_project_type`
--

CREATE TABLE `field_data_field_project_type` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_project_type_tid` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`),
  KEY `field_project_type_tid` (`field_project_type_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 11 (field_project_type)';
...
CREATE TABLE `field_data_field_video_link` (
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_video_link_video_url` varchar(512) DEFAULT '',
  `field_video_link_thumbnail_path` varchar(512) DEFAULT '',
  `field_video_link_video_data` longblob,
  `field_video_link_embed_code` varchar(1024) DEFAULT '',
  `field_video_link_description` text,
  PRIMARY KEY (`entity_type`,`entity_id`,`deleted`,`delta`,`language`),
  KEY `entity_type` (`entity_type`),
  KEY `bundle` (`bundle`),
  KEY `deleted` (`deleted`),
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 9 (field_video_link)';
...
CREATE TABLE `field_revision_field_caption` (
  ...
  KEY `language` (`language`),
  KEY `field_caption_format` (`field_caption_format`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 7 (field_caption)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_client`
--

CREATE TABLE `field_revision_field_client` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_client_tid` (`field_client_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 10 (field_client)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_cover_image`
--
...
CREATE TABLE `field_revision_field_cover_image` (
  ...
  KEY `language` (`language`),
  KEY `field_cover_image_fid` (`field_cover_image_fid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 6 (field_cover_image)';

-- --------------------------------------------------------

--
-- Table structure for table `field_revision_field_external_url`
--

CREATE TABLE `field_revision_field_external_url` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 8 (field_external_url)';
...
--
-- Table structure for table `field_revision_field_project_type`
--

CREATE TABLE `field_revision_field_project_type` (
  `entity_type` varchar(128) NOT NULL DEFAULT '' COMMENT 'The entity type this data is attached to',
  `bundle` varchar(128) NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) unsigned NOT NULL COMMENT 'The entity id this data is attached to',
  ...
  KEY `language` (`language`),
  KEY `field_project_type_tid` (`field_project_type_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 11 (field_project_type)';
...
CREATE TABLE `field_revision_field_video_link` (
  ...
  KEY `revision_id` (`revision_id`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Revision archive storage for field 9 (field_video_link)';
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores sitewide and user follow links.' AUTO_INCREMENT=2 ;
...
CREATE TABLE `page_manager_pages` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `task` (`task`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contains page subtasks for implementing pages with...' AUTO_INCREMENT=2 ;
...
--
-- Table structure for table `path_breadcrumbs`
--

CREATE TABLE `path_breadcrumbs` (
  `path_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Breadcrumb’s variant unique identifier',
  `machine_name` varchar(64) NOT NULL COMMENT 'Breadcrumb’s variant machine name',
  `name` varchar(64) NOT NULL COMMENT 'Breadcrumb’s variant human-readable name',
  `path` varchar(256) NOT NULL COMMENT 'URL where breadcrumb should be shown',
  `data` longblob NOT NULL COMMENT 'Serialized data of breadcrumb',
  `weight` int(11) NOT NULL DEFAULT '0' COMMENT 'Breadcrumb weight related to other breadcrumbs',
  PRIMARY KEY (`path_id`),
  UNIQUE KEY `machine_name` (`machine_name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores path breadcrumbs.' AUTO_INCREMENT=2 ;
...
CREATE TABLE `taxonomy_term_data` (
  ...
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores term information.' AUTO_INCREMENT=25 ;
...
CREATE TABLE `taxonomy_vocabulary` (
  ...
  UNIQUE KEY `machine_name` (`machine_name`),
  KEY `list` (`weight`,`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores vocabulary information.' AUTO_INCREMENT=5 ;
