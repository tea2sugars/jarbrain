...
To use these stylesheets, rename the files and jarbrain with the name of your theme.
...
jarbrain-alpha-default-narrow.css  
...
jarbrain-alpha-default-normal.css
...
jarbrain-alpha-default-wide.css
